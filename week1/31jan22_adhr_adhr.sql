...
FROM
    emp
ORDER BY
    deptno,empno; -- first sort depno and then in that it create kind group and sort that group based on the empno
...
ORDER BY
   sal desc;
--###################################################3
-- if we want to sort the depno in acendig and emp no in decending
